...
ROBOT_DOWN_LEFT = 'DL'
ROBOT_DOWN_RIGHT = 'DR'
ROBOT_ORIENTATIONS = [ROBOT_UP, ROBOT_DOWN, ROBOT_UP_LEFT,
                      ROBOT_UP_RIGHT, ROBOT_DOWN_LEFT, ROBOT_DOWN_RIGHT]
...
ACTION_BASE_COST = {FORWARD: 1.0, REVERSE: 1.0,
                    SPIN_LEFT: 0.1, SPIN_RIGHT: 0.1}
ACTION_PUSH_COST = {FORWARD: 0.8, REVERSE: 0.5,
                    SPIN_LEFT: 0.0, SPIN_RIGHT: 0.0}
...
# double lowercase letter is valid but ignored
IGNORED_SYMBOLS = [2 * c for c in string.ascii_lowercase]

ALL_VALID_SYMBOLS = ROBOT_ORIENTATIONS + \
    WIDGET_SYMBOLS + ENVIRONMENT_SYMBOLS + IGNORED_SYMBOLS
